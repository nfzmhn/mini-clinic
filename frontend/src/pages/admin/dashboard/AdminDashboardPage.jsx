...
const stats = [
  { label: 'Total Pasien Terdaftar', value: '1.284', sub: 'Database MySQL aktif', icon: 'group', color: 'bg-[#b3ebff]/30 text-[#00677d]' },
  { label: 'Pengguna Sistem', value: '38', sub: '8 Dokter • 22 Petugas', icon: 'badge', color: 'bg-[#d7e2ff] text-[#001637]' },
  { label: 'Poliklinik Aktif', value: '4', sub: 'Umum, Gigi, Anak, KIA', icon: 'local_hospital', color: 'bg-[#50d9fe]/20 text-[#005c70]' },
  { label: 'Kunjungan Hari Ini', value: '128', sub: '24 Antrean pending', icon: 'monitor_heart', color: 'bg-[#6ffbbe]/30 text-[#005236]' },
]
    ...
    <div className="admin-page">
      ...
      <div className="admin-main">
        ...
        <main className="admin-content">
          <div>
            <h1 className="font-headline text-2xl font-bold text-primary">Selamat Datang, Administrator Sistem</h1>
          ...
          <section className="bg-white rounded-2xl border border-[#c4c6d0]/30 shadow-sm p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <NavLink to="/admin/patients" className="text-xs font-bold text-secondary hover:underline">Buka Master Pasien →</NavLink>
            </div>
